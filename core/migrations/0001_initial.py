    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article_type', models.CharField(choices=[('industry_report', 'Industry Report'), ('research_paper', 'Research Paper'), ('white_paper', 'White Paper'), ('technical_paper', 'Technical Paper'), ('market_analysis', 'Market Analysis'), ('framework_guide', 'Framework Guide')], max_length=20)),
                ('tags', models.JSONField(default=list)),
                ('pdf_file', models.FileField(blank=True, null=True, upload_to='articles/')),
                ('external_url', models.URLField(blank=True)),
                ('is_featured', models.BooleanField(default=False)),
                ('read_time', models.PositiveIntegerField(default=15, help_text='Estimated read time in minutes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_description', models.TextField(default='Empowering Businesses with AI')),
                ('contact_email', models.EmailField(default='info@ai-solution.com', max_length=254)),
